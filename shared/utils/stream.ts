export function unionBy<T>(
  ...
  const keyFn =
    typeof iteratee === "function"
      ? iteratee
      : (item: T) => (iteratee ? item[iteratee] : item);
...
export function mapAsyncIterator<T, R>(
  iterator: AsyncIterator<T> | AsyncIterable<T>,
...
export async function* streamToAsyncIterable<T = string>(
...
export async function* streamToIterator<T, R = any>(
  stream: ReadableStream<T>,
